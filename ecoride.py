    ...
    if opcion == "1":
        ...
        while True:
            ...
            if dia=="s" or dia=="n":
                ...
                continue
        # validación devolución a tiempo
        while True:
            ...
            if retraso=="s" or retraso=="n":
                ...
                print("Opción invalida")
                continue
        #verifica si hay aplicacion de descuento
        if metodo_pago=="tarjeta":
            if minutos>60:
                descuento=costo_base*0.10
        elif metodo_pago=="puntos" and minutos<10:
            descuento=0
        #evalúa si se aplica recargo por fin de semana
        if dia=="s":
            recargo=costo_base*0.05
        else:
            recargo=0
        #evalúa si se entregó a tiempo la bicicleta
        if retraso!="s":
            penalizacion=0
        else:
        ...
        print("===============================")
        #evalúa si toca repetir el menú nuevamente
        while True:
